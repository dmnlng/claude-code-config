...
echo -e "   ${CYAN}/init${NC}             - Complete project setup (RUN THIS FIRST!)"
echo -e ""
echo -e "${BLUE}This will guide you through:${NC}"
echo -e "   • Claude Code configuration"
echo -e "   • Git repository setup"
echo -e "   • Project manifest creation"
echo -e "   • Readiness validation"
echo -e ""
...
echo -e "   ${CYAN}/feature${NC} \"...\"    - Create new feature (after /init)"
echo ""
